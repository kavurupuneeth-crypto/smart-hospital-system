    ...
    <div>
      ...
      <div className="bg-white rounded-2xl shadow-md p-8">
        <div className="flex items-center gap-3 mb-6">
          <span className="material-symbols-rounded text-3xl text-blue-600">palette</span>
          <div>
              ...
              <div className="flex flex-col items-center text-center">
                ...
                {theme === themeOption.id && (
                  <div className="absolute top-3 right-3">
                    <span className="material-symbols-rounded text-blue-600 text-2xl">check_circle</span>
                  </div>
                )}
              </div>
            </button>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-600 mt-1">
                Your theme preference is saved and will be applied across all pages instantly.
              </p>
            </div>
          </div>
        </div>
